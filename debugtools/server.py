...
def sender(out_addr):
    ...
    while(True):
        time.sleep(1)
        count += 1
        data_frame = b"clock-indicated=,aileron=-0.900000,elevator=-1.000000,rudder=1.000000,flaps=0.375000,throttle0=1.000000,throttle1=1.000000,vsi-fpm=0.000000,alt-ft=30.058054,ai-pitch=-18.443966,ai-roll=-86.965988,ai-offset=0.000000,hi-heading=21.903837,roll-deg=-86.965991,pitch-deg=-18.443966,heading-deg=31.352836,airspeed-kt=120.111656,speed-north-fps=176.087646,speed-east-fps=83.970360,speed-down-fps=72.969231,uBody-fps=207.182892,vBody-fps=-8.866049,wBody-fps=-19.467810,north-accel-fps_sec=-43.516373,east-accel-fps_sec=2.719708,down-accel-fps_sec=-108.411034,x-accel-fps_sec=-78.381805,y-accel-fps_sec=123.183800,z-accel-fps_sec=18.470041,latitude=21.332679,longitude=-157.946107,altitude=31.399259,frame=%d,crashed=0"%count
